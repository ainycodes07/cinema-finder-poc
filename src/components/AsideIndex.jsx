  ...
  <>
    ...
    <List>
      <ListItem button component={RouterLink} to='/all-cinemas/au'>
        ...
        {/* Add white color to icon */}
          <Icon sx={{ color: "#ffffff" }}><GiAustralia /></Icon>
        </ListItemIcon>
        <ListItemText>
          Australia
        </ListItemText>
        {/* Set Explicit white color with distinct grey background for Chip componenet which holds the counts */}
        <Chip sx={{ backgroundColor: "#333333", color: "#ffffff", fontWeight: "bold" }} label={breakdown.au} />
      </ListItem>
      <ListItem button component={RouterLink} to='/all-cinemas/nz'>
        <ListItemIcon>

        {/* Add white color to icon */}
        <Icon sx={{ color: "#ffffff" }}><GiFern /></Icon>
        </ListItemIcon>
        <ListItemText>
          New Zealand
        </ListItemText>
        ...
        {/* Set Explicit white color with distinct grey background for Chip componenet which holds the counts */}
        <Chip sx={{ backgroundColor: "#333333", color: "#ffffff", fontWeight: "bold" }} label={breakdown.nz} />
      </ListItem>
    </List>
    ...
    <List sx={{ mt: 2, pt: 1, borderTop: 1, borderColor: 'divider' }}>
      <ListItem button component={RouterLink} to='/nearby'>
        <ListItemIcon>
          {/* Add white color to icon */}
          <Icon sx={{ color: "#ffffff" }}><MdLocationSearching /></Icon>
        </ListItemIcon>
        <ListItemText>
          Nearby Cinemas
        </ListItemText>
